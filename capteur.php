...
<body class="bg-grey inter"> <!-- police + fond -->
            ...
            <div class="collapse navbar-collapse" id="navbarNavDropdown">
                <ul class="navbar-nav w-100 d-flex justify-content-center">
                    <b class="w75 d-flex justify-content-between flexres">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" aria-current="page" href="./capteur.html">Capteur</a>
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="./contact.html">Profil</a> <!-- page contact -->
                        </li>
                    </b>
                </ul>
            </div>
    ...
    <footer class="bg-white pb-1">
        ...
        <div class="container-fluid d-flex flex-wrap align-items-center justify-content-between footer-block">
            ...
            <div class="d-flex flex-wrap gap-3 align-items-center justify-content-center mx-5 m0333">
                ...
                <a href="https://www.lachainemeteo.com/" target="_blank"><img src="./image/chaine_météo.png" class="w60"
                        alt="sponsor la chaine météo"></a>
    ...
    <script src="./script/script_humidite.js"></script>
    <script src="./script/script_air.js"></script>
    <script src="./script/script_json1.js"></script>
    <script src="./script/script_json2.js"></script>
    <script src="./script/script_json3.js"></script>
    <script src="./script/script_json4.js"></script>
    <script src="./script/script_json5.js"></script>
    <script src="./script/script_json6.js"></script>
</body>
